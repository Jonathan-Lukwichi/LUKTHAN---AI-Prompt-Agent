...
export interface AgentResponse {
  // Core response
  response?: string;
  response_type: 'conversation' | 'question' | 'prompt_optimization' | 'hybrid' | 'smart' | 'wisdom';
  intent: 'conversation' | 'question' | 'prompt_optimization' | 'hybrid';
...
export interface Settings {
  domain: 'auto' | 'research' | 'coding' | 'data_science' | 'general';
